...
CreateButton("btnname", "bruh", function()
    print("button was clicked")
end)
 
CreateToggle("click then read", "bruh", function(v)
    if v == true then
        print("yes")
    else
        print("no")
...
CreateBox("boxxy", "bruh", function(V)
    print(V)
end)
 
CreateSlider("Set Walkspeed", "bruh", 16, 100, function(input)
